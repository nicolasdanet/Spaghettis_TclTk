...
proc show {top sizes title fontSize} {
    ...
    if {[winfo exists $top]} {
        ...
        _create $top $sizes $title $fontSize
    }
}
...
proc _create {top sizes title fontSize} {
    ...
    wm geometry $top [format "%s%s" $sizes [::rightNextTo $::var(windowFocused)]]
