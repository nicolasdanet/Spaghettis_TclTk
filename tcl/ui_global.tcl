...
proc expanded  {x} { return [string map {"," " \\, " ";" " \\; " "$" "\\$"} $x] }
proc sanitized {x} { return [string map {" " "_" ";" "" "," "" "{" "" "}" "" "\\" ""} $x] }

# ------------------------------------------------------------------------------------------------------------
# ------------------------------------------------------------------------------------------------------------

proc parseEmpty {x} { if {$x eq $::var(nil)} { return "" } else { return $x } }
proc withEmpty  {x} { if {$x eq ""} { return $::var(nil) } else { return $x } }
