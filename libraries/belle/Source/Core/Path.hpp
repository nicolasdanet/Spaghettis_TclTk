...
#ifndef BELLE_CORE_PATH_HPP
#define BELLE_CORE_PATH_HPP
...
public:
    void addEllipse (Point origin, Vector scale, double rotation, bool ccw = true)
    {
        ...
        //
        b0 = Bezier::reverse (Bezier::makeEllipticalArc (origin, scale, rotation, 1));
        b1 = Bezier::reverse (Bezier::makeEllipticalArc (origin, scale, rotation, 2));
        b2 = Bezier::reverse (Bezier::makeEllipticalArc (origin, scale, rotation, 3));
        b3 = Bezier::reverse (Bezier::makeEllipticalArc (origin, scale, rotation, 4));
    ...
    void addLine (Point a, Point b, double width, bool isCap = true, bool ccw = true)
    {
        ...
        //
        e1 = Bezier::reverse (Bezier::makeEllipticalArc (b, Vector (width, width), angle - kHalfPi, 1));
        e2 = Bezier::reverse (Bezier::makeEllipticalArc (b, Vector (width, width), angle - kHalfPi, 2));
        s1 = Bezier::reverse (Bezier::makeEllipticalArc (a, Vector (width, width), angle - kHalfPi, 3));
        s2 = Bezier::reverse (Bezier::makeEllipticalArc (a, Vector (width, width), angle - kHalfPi, 4));
