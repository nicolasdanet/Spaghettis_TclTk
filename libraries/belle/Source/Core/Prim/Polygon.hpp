...
#ifndef PRIM_POLYGON_HPP
#define PRIM_POLYGON_HPP
...
private:
    ...
    public:
        ...
        SortablePoint (const Point & pt, double ang, double mag) : pt_ (pt), angle_ (ang), distance_ (mag)
        {
        }
...
public:
    void swapWith (Polygon& o) noexcept
    {
