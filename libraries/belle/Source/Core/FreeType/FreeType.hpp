...
#ifndef BELLE_FREETYPE_HPP
#define BELLE_FREETYPE_HPP
...
/* Tested with 2.5.2 version. */
/* Tested with 2.5.3 version. */
/* Tested with 2.6.3 version. */
/* Tested with 2.8.0 version. */
/* Tested with 2.8.1 version. */
...
bool Typeface::importFont (const ascii* filename)
{
    Array < byte > rawData;
