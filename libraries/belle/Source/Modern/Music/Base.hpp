...
#ifndef BELLE_MODERN_MUSIC_BASE_HPP
#define BELLE_MODERN_MUSIC_BASE_HPP
...
private:
    MusicBase (const MusicBase&);
    MusicBase& operator = (const MusicBase&);
...
// -----------------------------------------------------------------------------------------------------------
// -----------------------------------------------------------------------------------------------------------
#endif // BELLE_MODERN_MUSIC_BASE_HPP
