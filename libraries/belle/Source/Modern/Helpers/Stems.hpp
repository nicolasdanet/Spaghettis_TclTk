...
#ifndef BELLE_MODERN_HELPERS_STEMS_HPP
#define BELLE_MODERN_HELPERS_STEMS_HPP
...
static Array < Box > getBoxes (Music& music, const Array < NodePtr > & chords, const Affine& context)
{
    ...
    for (int i = 0; i < chords.size(); ++i) { 
        ...
        stems.add (Affine::inverse (context).appliedTo (box));
    }
...
// -----------------------------------------------------------------------------------------------------------
// -----------------------------------------------------------------------------------------------------------
#endif // BELLE_MODERN_HELPERS_STEMS_HPP
