...
#ifndef BELLE_MODERN_HELPERS_SPACING_HPP
#define BELLE_MODERN_HELPERS_SPACING_HPP
...
{
    Point origin (Affine::inverse (Affine::scale (scale_)).appliedTo (origin_));
...
// -----------------------------------------------------------------------------------------------------------
// -----------------------------------------------------------------------------------------------------------
#endif // BELLE_MODERN_HELPERS_SPACING_HPP
