...
#ifndef BELLE_MODERN_BUILDERS_GRAND_STAFF_HPP
#define BELLE_MODERN_BUILDERS_GRAND_STAFF_HPP
...
private:
    GrandStaff (const GrandStaff&);
    GrandStaff& operator = (const GrandStaff&);
...
// -----------------------------------------------------------------------------------------------------------
// -----------------------------------------------------------------------------------------------------------
#endif // BELLE_MODERN_BUILDERS_GRAND_STAFF_HPP
