...
#ifndef BELLE_SYMBOLS_TIE_HPP
#define BELLE_SYMBOLS_TIE_HPP
...
private:
    Path getTie (Box& box) const
    {
        ...
        Bezier c2 = Bezier::reverse (Bezier::makeConvexCurveInBox (box, curve, (position_ != mica::Below)));
