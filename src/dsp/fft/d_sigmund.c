...
/* Note that for now sigmund~ is reset with encapsulation. */
...
t_float *sigmund_tilde_reserve1 (t_sigmund_tilde *, int);
t_float *sigmund_tilde_reserve2 (t_sigmund_tilde *, int);
t_float *sigmund_tilde_reserve3 (t_sigmund_tilde *, int);
...
static void sigmund_tilde_list (t_sigmund_tilde *x, t_symbol *s, int argc, t_atom *argv)
{
    ...
    if ((a = (t_garray *)symbol_getThingByClass (name, garray_class))) {
    //
...
t_float *sigmund_tilde_reserve1 (t_sigmund_tilde *x, int n)
{
    PD_ASSERT (n > 0);
...
t_float *sigmund_tilde_reserve2 (t_sigmund_tilde *x, int n)
{
    PD_ASSERT (n > 0);
...
t_float *sigmund_tilde_reserve3 (t_sigmund_tilde *x, int n)
{
    PD_ASSERT (n > 0);
