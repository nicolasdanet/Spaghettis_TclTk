...
void canvas_vis(t_canvas *x, t_floatarg f)
{
    ...
    if (flag)
    {
        ...
        {           /* just put us in front */
            sys_vgui("::pd_patch::bringToFront .x%lx\n", x);  
        }
        else
        {
...
void glob_verifyquit(void *dummy, t_floatarg f)
{
    ...
    {
        canvas_vis(g2, 1);
            sys_vgui("::dialog_confirm::checkClose .x%lx {::pd_connect::pdsend $top menusave 1} {::pd_connect::pdsend .x%lx menuclose 3} {}\n",
...
void canvas_menuclose(t_canvas *x, t_floatarg fforce)
{
    ...
    else if (force == 0)    
    {
        ...
        if (g)
        {
            ...
            sys_vgui("::dialog_confirm::checkClose .x%lx {::pd_connect::pdsend $top menusave 1} {::pd_connect::pdsend .x%lx menuclose 2} {}\n",
