...
t_symbol *sym___dash__d;
t_symbol *sym___dash__discard;
t_symbol *sym___dash__e;
...
void symbols_initialize (void)
{
    ...
    sym___TEMPLATE__text                        = symbol_makeTemplateIdentifier (gensym ("text"));
    ...
    sym___dash__d                               = gensym ("-d");
    sym___dash__discard                         = gensym ("-discard");
    sym___dash__e                               = gensym ("-e");
