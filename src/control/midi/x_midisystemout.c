...
static t_buffer *midisystemout_functionData (t_gobj *z, int flags)
{
    if (SAVED_DEEP (flags)) {
    //
...
{
    t_midisystemout *old = (t_midisystemout *)instance_pendingFetch (cast_gobj (x));
