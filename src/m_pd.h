...
// -----------------------------------------------------------------------------------------------------------
    ...
    #define PD_STRUCT extern struct
#else
...
PD_DLL void sys_logerror    (const char *object, const char *s);
PD_DLL void sys_unixerror   (const char *object);
PD_DLL void sys_ouch        (void);
