...
t_int *vPerform_inverseMagnitude (t_int *w)
{
    ...
    s3[0] = (t_sample)rsqrt_fast ((t_float)(f0 * f0 + g0 * g0));
    s3[1] = (t_sample)rsqrt_fast ((t_float)(f1 * f1 + g1 * g1));
    s3[2] = (t_sample)rsqrt_fast ((t_float)(f2 * f2 + g2 * g2));
    s3[3] = (t_sample)rsqrt_fast ((t_float)(f3 * f3 + g3 * g3));
    s3[4] = (t_sample)rsqrt_fast ((t_float)(f4 * f4 + g4 * g4));
    s3[5] = (t_sample)rsqrt_fast ((t_float)(f5 * f5 + g5 * g5));
    s3[6] = (t_sample)rsqrt_fast ((t_float)(f6 * f6 + g6 * g6));
    s3[7] = (t_sample)rsqrt_fast ((t_float)(f7 * f7 + g7 * g7));
