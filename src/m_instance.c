...
void instance_initialize (void)
{
    ...
    pd_objectMaker = class_new (sym_objectmaker, NULL, NULL, sizeof (t_pd), CLASS_DEFAULT, A_NULL);
    pd_canvasMaker = class_new (sym_canvasmaker, NULL, NULL, sizeof (t_pd), CLASS_DEFAULT, A_NULL);
