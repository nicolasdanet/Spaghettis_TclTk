...
void midi_pushSysexNativeAllocate (int port, int argc, t_atom *argv)
{
...
void midi_pollNativeEventSysex (int port, snd_seq_event_t *e)
{
...
void midi_pollNativeEvent (int port, snd_seq_event_t *e)
{
